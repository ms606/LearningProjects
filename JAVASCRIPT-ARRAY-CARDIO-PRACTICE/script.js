...
// 1. filer the invnetors who were born in 150's
...
// 3. Sort the invetors by birthdate, oldest to youngest 
const ordered = inventors.sort((a,b) => (a.year > b.year) ? 1 : -1);
// console.table(ordered);

// Array.prototype.reduce()
// 4. How many years inventors lived
const ttlAge = inventors.reduce((total, inventor) => {
...
const transprot = data.reduce((obj,itm) => {
